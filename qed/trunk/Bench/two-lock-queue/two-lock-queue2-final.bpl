...
procedure enqueue(value: Object);
  modifies QueueItem_alloc, QueueItem_value, QueueItem_next, tail, Mutex_owner, QueueItem_alloc, QueueItem_value, tail, Mutex_owner;



implementation enqueue(value: Object)
{
  var node: QueueItem;
  var t: QueueItem;
  var ex: Exception;
...
procedure dequeue() returns (result: Object);
  modifies head, Mutex_owner, head, Mutex_owner;



implementation dequeue() returns (result: Object)
{
  var x: Object;

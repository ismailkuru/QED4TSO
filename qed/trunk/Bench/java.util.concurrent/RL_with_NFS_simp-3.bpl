...
implementation AQS_setHead(this: NonfairSync, node: Node)
{
  Atomic_18:
    atomic { // Non-mover
        assert init[this] == True;
        assert ownerHead[this] == tid;
        this.head := node;
    }
...
procedure {:ispublic false} AQS_acquireQueued(this: NonfairSync, node: Node, arg: int) returns (result: bool);
  modifies ownerHead, Node_next, ownerHead;
...
procedure {:ispublic true} AQS_acquire(this: NonfairSync, arg: int);
  modifies con, Node_nextWaiter, Node_thread, Node_waitStatus, NonfairSync_head, NonfairSync_tail, owner, ownerHead;
...
procedure {:ispublic false} NonfairSync_lock(this: NonfairSync);
  modifies NonfairSync_exclusiveOwnerThread, NonfairSync_state, con, Node_nextWaiter, Node_thread, Node_waitStatus, NonfairSync_head, NonfairSync_tail, owner, ownerHead;
...
invariant (forall node: Node :: node.alloc == Alloc ==> owner[node] != 0);

var ownerHead: [NonfairSync]int;

var {:isaux} init: [NonfairSync]boolean;

...
invariant null.next == null && null.prev == null && owner[null] == 0 && null.owned == 0 && null.alloc == False;
...
invariant (forall elem: Lelem :: elem.alloc == False ==> elem.owned == 0);

invariant (forall elem: Lelem, t: int :: owner[elem] == t && t > 0 && tail != null && ReachBetween(Lelem_next, elem, tail, tail) ==> wlock == t && elem.next == null);

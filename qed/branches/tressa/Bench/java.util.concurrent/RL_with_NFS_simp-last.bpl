...
procedure {:ispublic true} AQS_acquire(this: NonfairSync, arg: int);
  modifies con, Node_nextWaiter, Node_thread, Node_waitStatus, NonfairSync_head, NonfairSync_tail, owner, Thread_interrupted, NonfairSync_state, lockedBy, NonfairSync_exclusiveOwnerThread, Node_alloc, Node_next, Node_prev;

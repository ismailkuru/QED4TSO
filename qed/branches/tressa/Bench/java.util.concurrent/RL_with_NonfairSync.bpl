...
procedure {:ispublic false} NonfairSync_NonfairSync(this: NonfairSync)
{
...
// ==========================================================================
procedure {:ispublic false} AQS_fullIsFirst(this: NonfairSync, current: Thread) returns (result: boolean)
{
...
procedure {:ispublic false} AQS_isFirst(this: NonfairSync, current: Thread) returns (result: boolean)
{
	var h: Node;
	var s: Node;
	var guard : bool;
...
// ==========================================================================
procedure AQS_release(this: NonfairSync, arg: int) returns (result: boolean)
{
	var h: Node;
	var guard: bool;
	var dummy: boolean;
...
procedure {:ispublic false} AQS_cancelAcquire(this: NonfairSync, node: Node)
{
	...
	if (guard)
	{
		...
		if (guard)
		{
			call dummy := AQS_compareAndSetTail(this, node, pred);
			guard := (dummy == True);
			if (guard)
			{
...
procedure {:ispublic false} AQS_parkAndCheckInterrupt(this: NonfairSync) returns (result: boolean)
{
	var currentThread: Thread;
	call currentThread := Thread_currentThread();
...
procedure {:ispublic false} AQS_acquireQueued(this: NonfairSync, node: Node, arg: int) returns (result: boolean)
{
...
// unsafe do.
procedure{:ispublic false} {:isatomic true} AQS_compareAndSetState(this: NonfairSync, expect: int, update: int) returns (result: boolean)
{
	var guard : bool;
...
procedure{:ispublic false} {:isatomic true} AQS_compareAndSetHead(this: NonfairSync, update: Node) returns (result: boolean)
{
	var guard : bool;
...
procedure{:ispublic false} {:isatomic true} AQS_compareAndSetTail(this: NonfairSync, expect: Node, update: Node) returns (result: boolean)
{
	var guard : bool;
...
// =================================================================================================
procedure {:ispublic false} Sync_tryRelease(this: NonfairSync, releases: int) returns (result: boolean)
{
...
procedure {:ispublic false} Sync_nonfairTryAcquire(this: NonfairSync, acquires: int) returns (result: boolean)
{
	var current: Thread;
	var c: int;
	var nextc: int;
...
// =================================================================================================
procedure {:ispublic false} NonfairSync_tryAcquire(this: NonfairSync, acquires: int) returns (result: boolean)
{
...
//{
//	call NonfairSync_NonfairSync(this.sync);
//}
